...
public class PickUpArena : MonoBehaviour
{
    ...
    void CheckSpaceBelow() // по идее должен фиксеть баг, когда пикапы разбиваются об голову игрока и находятся выше положенного
    {
        RaycastHit hit;
