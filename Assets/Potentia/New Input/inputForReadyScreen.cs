...
//     version 1.7.0
//     from Assets/Potentia/New Input/inputForReadyScreen.inputactions
//
...
public partial class @InputForReadyScreen: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputForReadyScreen()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""inputForReadyScreen"",
    ""maps"": [
        {
            ""name"": ""Cloud"",
    ...
    {
        private @InputForReadyScreen m_Wrapper;
        public CloudActions(@InputForReadyScreen wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputForReadyScreen m_Wrapper;
        public MageActions(@InputForReadyScreen wrapper) { m_Wrapper = wrapper; }
